 ...
 * Find the sweet spot between 2k (fast) and 32k (hung)
 */

const ROUTER_URL = 'http://192.168.0.21:3000';
const API_KEY = 'test-key';

async function test20kContext() {
  console.log('\n🧪 Testing with ~20k token context\n');
...
// Run test
console.log('═══════════════════════════════════════');
console.log('  20K Context Speed Test');
console.log('═══════════════════════════════════════');

test20kContext().then(success => {
  console.log('═══════════════════════════════════════');
  if (success) {
